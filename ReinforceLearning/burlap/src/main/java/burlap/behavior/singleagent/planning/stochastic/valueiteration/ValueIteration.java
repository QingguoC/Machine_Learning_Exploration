...
public class ValueIteration extends DynamicProgramming implements Planner {
	...
	//record maxDelta in each value iteration
	protected ArrayList<Double> maxDeltaInEachIteration;
	...
	//I added variable totalValueIterations to record total value iterations
	...
	public ValueIteration(SADomain domain, double gamma, HashableStateFactory hashingFactory, double maxDelta, int maxIterations){
		...
		this.maxDeltaInEachIteration = new ArrayList<Double>();
		
	}
	// no limit on delta
	public ValueIteration(SADomain domain, double gamma, HashableStateFactory hashingFactory, int maxIterations){
	...
	// no limit on iteration, converge by delta
	public ValueIteration(SADomain domain, double gamma, HashableStateFactory hashingFactory, double maxDelta){
	...
	public void runVI(){
		...
		for(i = 0; i < this.maxIterations; i++){
			...
			this.maxDeltaInEachIteration.add(delta);
