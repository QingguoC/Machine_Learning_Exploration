...
//	//record maxDelta of value update in each Policy iteration
//	protected ArrayList<Double> maxDeltaInEachIteration = new ArrayList<Double>();
//
//	public ArrayList<Double> getMaxDeltaInEachIteration() {
//		return maxDeltaInEachIteration;
//	}



	//record delta in each Policy iteration
	protected ArrayList<Double> deltaInEachPIteration = new ArrayList<Double>();

	public ArrayList<Double> getDeltaInEachPIteration() {
		return deltaInEachPIteration;
	}
	/**
	...
	public PolicyIteration(SADomain domain, double gamma, HashableStateFactory hashingFactory, int maxEvaluationIterations, int maxPolicyIterations){
		this.DPPInit(domain, gamma, hashingFactory);

		this.maxEvalDelta = Double.NEGATIVE_INFINITY;
		this.maxPIDelta = Double.NEGATIVE_INFINITY;
		this.maxIterations = maxEvaluationIterations;
		this.maxPolicyIterations = maxPolicyIterations;
	...
	public GreedyQPolicy planFromState(State initialState) {
		...
		if(this.performReachabilityFrom(initialState) || !this.hasRunPlanning){
			...
			do{
				...
				iterations++;
				this.evaluativePolicy = new GreedyQPolicy(this.getCopyOfValueFunction());
				deltaInEachPIteration.add(delta);
